            ...
            if (installed)
            {
                ...
                stack.Children.Add(Card("Кто занимается функциональным рядом", null,
                    Note("Драйвер даёт медиаклавиши и настоящую Fn, но переназначать верхний " +
                         ...
                         "Яркость внешних мониторов требует двух вещей разом: чтобы F1 и F2 " +
                         "дошли до программы — то есть режим драйвера «F-клавиши сразу» или " +
                         "драйвера нет вовсе, — и чтобы «Основной режим» на странице «Клавиши» " +
                         "стоял на медиафункциях либо был зажат заменитель Fn. Драйвер " +
