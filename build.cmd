...
"%NETDIR%\csc.exe" /nologo /target:winexe /optimize+ /platform:anycpu /codepage:65001 ^
  ...
  "%~dp0BuildInfo.cs" "%~dp0Updater.cs" "%~dp0Diag.cs" "%~dp0Iconography.cs" "%~dp0Native.cs" "%~dp0Models.cs" "%~dp0AppleDriver.cs" "%~dp0AppleDriverSetup.cs" "%~dp0KeyWatch.cs" "%~dp0KeyboardBattery.cs" "%~dp0AppleLayout.cs" "%~dp0Input.cs" "%~dp0MacKeys.cs" "%~dp0Actions.cs" "%~dp0Brightness.cs" ^
